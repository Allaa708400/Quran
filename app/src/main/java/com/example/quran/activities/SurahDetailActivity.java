...
public class SurahDetailActivity extends AppCompatActivity {
    ...
    private String arb = "arabic_moyassar";
        ...
        settingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BottomSheetDialog bottomSheetDialog = new
                        BottomSheetDialog(SurahDetailActivity.this,
                ...
                view.findViewById(R.id.save_setting_button).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
